...
|-------|---------|------|--------|------|
| 사전 완료 | 12 | 12 | 100% | ✅ |
| Phase 0 | 37 | 33 | 89% | 🔶 진행 중 |
| Phase 1 | 62 | 0 | 0% | ⬜ 미시작 |
| Phase 2 | 68 | 0 | 0% | ⬜ 미시작 |
| Phase 3 | 36 | 0 | 0% | ⬜ 미시작 |
| **MVP 합계** | **215** | **45** | **21%** | |

**→ 다음: P0-33 (적재 파이프라인) + P0-37 (비용 문서화) + P0-28 (Vercel 배포) → Gate 0**
...
| P0-33 | 초기 데이터 적재 파이프라인 | P0-29/32 결정 기반. 카카오 API → 변환 → DB 적재 프로토타입. 관리자 동기화 기능의 백엔드 | 파이프라인 동작 확인 | ⬜ |
