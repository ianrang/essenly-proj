...
| ID | 작업 | 상세 | 산출물 | 상태 |
|----|------|------|--------|------|
| P0-1 | PRD v2.0 → v2.1 리뷰 | 비즈니스 이슈 20건 + 기술 혼입 19개소 제거 + DB/TDD 이관 8건. 해소 8건, 사용자 결정 14건, P0-2 이관 8건 | PRD 리뷰 리포트 (`docs/04-poc/prd-review.md`) | ✅ |
...
**→ 다음 작업: P0-14~P0-18 (LLM PoC Phase 2~3) + P0-3 (성공 지표) + P0-11 (버전별 범위)**
