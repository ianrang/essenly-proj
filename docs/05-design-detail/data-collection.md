...
| **U-3** | EU CosIng K-뷰티 성분 커버리지 | ~~중~~ **확정** | — | **검증 완료 (2026-03-24)** | **P2-V4 완료.** K-뷰티 핵심 20성분 샘플 매칭률 **100%** (20/20). 글로벌 표준 성분(niacinamide, retinol 등) + K-뷰티 특화 성분(snail secretion filtrate, artemisia princeps, oryza sativa)도 INCI 시스템에 등재 확인. CosIng CSV를 function[] 소스로 사용 가능 |
