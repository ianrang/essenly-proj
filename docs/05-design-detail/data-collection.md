...
Phase B (A 완료 후): products(S7 쿠팡 파트너스 + 수동)
...
| 필요 사항 | 상세 |
|----------|------|
| 전체 수량 | products 200+, stores 50+, clinics 30+, treatments 50+, ingredients 100+, brands 50+ |
...
| junction (자동+검수) | ~2분 | ~700 (검수 대상) | ~12시간 | product_stores 9,900건 자동, product_ingredients 689건 LLM+D-7, clinic_treatments 5,611건 카카오맵 태그+LLM+D-7. 수동 매핑 → LLM+검수로 대체 |
| **합계** | | | **~106시간** | **1인 풀타임(8h/일) 약 13일** |
